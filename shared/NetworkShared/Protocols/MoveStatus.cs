...
namespace FlatBuffers.Protocol
{
  public struct MoveStatus : IFlatbufferObject
  {
    ...
    public struct Model
    {
      ...
      public Model(int sequence, FlatBuffers.Protocol.Position.Model position, bool moving, int direction)
      {
        Sequence = sequence;
        Position = position;
        Moving = moving;
    ...
    public static byte[] Bytes(int sequence, FlatBuffers.Protocol.Position.Model position, bool moving, int direction) {
