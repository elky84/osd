...
public struct Stop : IFlatbufferObject
{
  ...
  public static void FinishStopBuffer(FlatBufferBuilder builder, Offset<Stop> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedStopBuffer(FlatBufferBuilder builder, Offset<Stop> offset) { builder.FinishSizePrefixed(offset.Value); }
