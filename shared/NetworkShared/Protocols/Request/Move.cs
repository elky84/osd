...
namespace FlatBuffers.Protocol.Request
{
  public struct Move : IFlatbufferObject
  {
    ...
    public struct Model
    {
      ...
      public Model(FlatBuffers.Protocol.Request.Position.Model position, long now, int direction)
      {
        Position = position;
        Now = now;
        Direction = direction;
    ...
    public static byte[] Bytes(FlatBuffers.Protocol.Request.Position.Model position, long now, int direction) {
