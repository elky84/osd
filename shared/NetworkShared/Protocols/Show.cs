...
namespace FlatBuffers.Protocol
{
  public struct Show : IFlatbufferObject
  {
    ...
    public struct Model
    {
      ...
      public Model(string name, int sequence, FlatBuffers.Protocol.Position.Model position)
      {
        Name = name;
        Sequence = sequence;
        Position = position;
    ...
    public static byte[] Bytes(string name, int sequence, FlatBuffers.Protocol.Position.Model position) {
      ...
      var offset = Show.CreateShow(builder, nameOffset, sequence, positionOffset);
