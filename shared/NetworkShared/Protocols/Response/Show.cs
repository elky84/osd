...
namespace FlatBuffers.Protocol.Response
{
  public struct Show : IFlatbufferObject
  {
    ...
    public struct Model
    {
      ...
      public Model(int sequence, string name, FlatBuffers.Protocol.Response.Position.Model position, bool moving, int direction)
      {
        Sequence = sequence;
        Name = name;
        Position = position;
    ...
    public static byte[] Bytes(int sequence, string name, FlatBuffers.Protocol.Response.Position.Model position, bool moving, int direction) {
