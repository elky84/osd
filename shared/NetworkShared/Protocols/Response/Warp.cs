...
namespace FlatBuffers.Protocol.Response
{
  public struct Warp : IFlatbufferObject
  {
    ...
    public struct Model
    {
      ...
      public Model(FlatBuffers.Protocol.Response.Position.Model position, long now)
      {
        Position = position;
        Now = now;
      }
    ...
    public static byte[] Bytes(FlatBuffers.Protocol.Response.Position.Model position, long now) {
