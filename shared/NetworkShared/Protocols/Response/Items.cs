...
namespace FlatBuffers.Protocol.Response
{
  public struct Items : IFlatbufferObject
  {
    ...
    public ulong Gold { get { int o = __p.__offset(8); return o != 0 ? __p.bb.GetUlong(o + __p.bb_pos) : (ulong)0; } }
    ...
    public static void AddGold(FlatBufferBuilder builder, ulong gold) { builder.AddUlong(2, gold, 0); }
    ...
    public struct Model
    {
      ...
      public Model(List<FlatBuffers.Protocol.Response.Item.Model> inventory, List<FlatBuffers.Protocol.Response.Equipment.Model> equipment, ulong gold)
      {
        Inventory = inventory;
        Equipment = equipment;
        Gold = gold;
    ...
    public static byte[] Bytes(List<FlatBuffers.Protocol.Response.Item.Model> inventory, List<FlatBuffers.Protocol.Response.Equipment.Model> equipment, ulong gold) {
      ...
      var offset = Items.CreateItems(builder, inventoryOffset, equipmentOffset, gold);
    ...
    public static byte[] Bytes(Model model) {
      return Bytes(model.Inventory, model.Equipment, model.Gold);
    }
  };
}