...
namespace FlatBuffers.Protocol.Response
{
  public struct ShowListDialog : IFlatbufferObject
  {
    ...
    public static void StartShowListDialog(FlatBufferBuilder builder) { builder.StartTable(2); }
    ...
    public struct Model
    {
      ...
      public Model(string message, List<string> list)
      {
        Message = message;
        List = list;
      }
    ...
    public static byte[] Bytes(string message, List<string> list) {
      ...
      using (var mstream = new MemoryStream())
      {
        using (var writer = new BinaryWriter(mstream))
        {
          ...
          writer.Write((byte)(typeof(ShowListDialog).FullName.Length));
          writer.Write(Encoding.Default.GetBytes(typeof(ShowListDialog).FullName));
          writer.Write(bytes);
          writer.Flush();
    ...
    public static byte[] Bytes(Model model) {
      return Bytes(model.Message, model.List);
    }
  };
}