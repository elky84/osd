...
namespace FlatBuffers.Protocol.Response
{
  public struct ShowDialog : IFlatbufferObject
  {
    ...
    public static byte[] Bytes(string message, bool next, bool quit) {
      ...
      using (var mstream = new MemoryStream())
      {
        using (var writer = new BinaryWriter(mstream))
        {
          ...
          writer.Write((byte)(typeof(ShowDialog).FullName.Length));
          writer.Write(Encoding.Default.GetBytes(typeof(ShowDialog).FullName));
          writer.Write(bytes);
          writer.Flush();
    ...
    public static byte[] Bytes(Model model) {
      return Bytes(model.Message, model.Next, model.Quit);
    }
  };
}