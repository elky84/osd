...
namespace FlatBuffers.Protocol
{
  public struct ShowCharacter : IFlatbufferObject
  {
    ...
    public struct Model
    {
      ...
      public Model(int sequence, string name, FlatBuffers.Protocol.Position.Model position, bool moving, int direction, List<FlatBuffers.Protocol.Equipment.Model> equipment)
      {
        Sequence = sequence;
        Name = name;
        Position = position;
    ...
    public static byte[] Bytes(int sequence, string name, FlatBuffers.Protocol.Position.Model position, bool moving, int direction, List<FlatBuffers.Protocol.Equipment.Model> equipment) {
